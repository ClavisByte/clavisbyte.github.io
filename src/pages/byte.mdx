  ...
  <ProfileSheet
    ...
    {[
      { 
        ...
        [
            { title: "About"
            , content: "The <b>Bionic Yielded Transformation Engine</b> (BYTE) is a system used by IV and Clavis in the form of a helmet. Remotely controlled by Clavis, the helmet allows IV to activate armour that Clavis can manifest around her." }
          , { title: "Backstory"
