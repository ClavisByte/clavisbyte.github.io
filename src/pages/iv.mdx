  ...
  <ProfileSheet
    ...
    {[
      { 
        ...
        miscellaneous:
        [
            { content: "Her name IV means four in Latin numerals. It is a reference to her series, Tetra in Greek meaning four." }
          , { content: "The nickname Ivy is a play her name, IV." }
